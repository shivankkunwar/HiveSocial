...
function HomeDesktop() {
  ...
  return (
    <ProCard split="vertical" className='pro-card-container' style={{paddingInline:"0"}}>
      <ProCard title="All posts" colSpan="70%" className='pro-card-left' style={{ display: "flex", background: "linear-gradient(#FDFDFD,#F5F5F5, #F5F5F5)" }}>
        <InfiniteScroll
          dataLength={items.length}
          next={fetchMoreData}
          hasMore={hasMoreItems}
          loader={<h4>Loading...</h4>}
          style={{ overflow: "none", padding:"0" }}
        >
      ...
      <ProCard title="Create Post" colSpan="30%" className='pro-card-right' style={{ background: "linear-gradient(#FDFDFD, #F5F5F5)", }} >
